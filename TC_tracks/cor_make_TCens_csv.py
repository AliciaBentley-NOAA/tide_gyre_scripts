...
#.attrib['hour']
         ...
         try:
            ...
            for i in range(len(thislon)):
               writer.writerow([thistime[i].strftime('%Y'),thistime[i].strftime('%m'),thistime[i].strftime('%d'),thistime[i].strftime('%H'),thispres[i],thislat[i],thislon[i],thisspeed[i],thismember])
      ...
      # Read non-UK forecast data (GFS, EC, CMC) data
         ...
         try:
            ...
            for i in range(len(clon)):
               writer.writerow([ctime[i].strftime('%Y'),ctime[i].strftime('%m'),ctime[i].strftime('%d'),ctime[i].strftime('%H'),cpres[i],clat[i],clon[i],cspeed[i]])
         finally:
            f.close()
